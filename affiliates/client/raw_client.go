...
func (r *RawClient) Create(
...
) (*core.Response[*whopsdk.Affiliate], error) {
	...
	var response *whopsdk.Affiliate
	...
	return &core.Response[*whopsdk.Affiliate]{
...
func (r *RawClient) Unarchive(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/affiliates/%v/unarchive",
		request.ID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
