...
func TestAPILogsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.APILogs.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestAPILogsListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestAPILogsListWithWireMock", "GET", "/api_logs", nil, 1)
}
