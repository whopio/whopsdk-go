...
func TestDepositsCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Deposits.Create(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestDepositsCreateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestDepositsCreateWithWireMock", "POST", "/deposits", nil, 1)
}
