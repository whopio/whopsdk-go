...
func (r *RawClient) Create(
...
) (*core.Response[*whopsdk.CreateDepositsResponse], error) {
	...
	endpointURL := baseURL + "/deposits"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
	headers.Add("Content-Type", "application/json")
	var response *whopsdk.CreateDepositsResponse
	...
	return &core.Response[*whopsdk.CreateDepositsResponse]{
