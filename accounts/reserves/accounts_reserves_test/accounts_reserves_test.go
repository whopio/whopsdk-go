...
package accounts_reserves_test
...
func TestAccountsReservesListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Accounts.Reserves.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestAccountsReservesListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestAccountsReservesListWithWireMock", "GET", "/accounts/account_id/reserves", nil, 1)
}
