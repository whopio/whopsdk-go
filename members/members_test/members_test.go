...
func TestMembersListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Members.List(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestMembersListWithWireMock"}},
		),
	)
...
func TestMembersRetrieveWithWireMock(
	...
	_, invocationErr := client.Members.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestMembersRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestMembersRetrieveWithWireMock", "GET", "/members/id", nil, 1)
}
