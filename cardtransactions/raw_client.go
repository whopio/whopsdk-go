...
func (r *RawClient) Retrieve(
...
) (*core.Response[*whopsdk.CardTransaction], error) {
	...
	var response *whopsdk.CardTransaction
	...
	return &core.Response[*whopsdk.CardTransaction]{
