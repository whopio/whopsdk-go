...
func TestAccountLinksCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.AccountLinks.Create(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestAccountLinksCreateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestAccountLinksCreateWithWireMock", "POST", "/account_links", nil, 1)
}
