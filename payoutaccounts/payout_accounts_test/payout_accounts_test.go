...
func TestPayoutAccountsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.PayoutAccounts.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestPayoutAccountsRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestPayoutAccountsRetrieveWithWireMock", "GET", "/payout_accounts/poact_xxxxxxxxxxxx", nil, 1)
}
