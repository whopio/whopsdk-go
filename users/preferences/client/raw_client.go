...
func (r *RawClient) Retrieve(
...
) (*core.Response[*whopsdk.UserPreferences], error) {
	...
	endpointURL := baseURL + "/users/me/preferences"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
	var response *whopsdk.UserPreferences
	...
	return &core.Response[*whopsdk.UserPreferences]{
