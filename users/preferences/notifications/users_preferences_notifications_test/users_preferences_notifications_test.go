...
package users_preferences_notifications_test
...
func TestUsersPreferencesNotificationsSetWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Users.Preferences.Notifications.Set(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestUsersPreferencesNotificationsSetWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestUsersPreferencesNotificationsSetWithWireMock", "PATCH", "/users/me/preferences/notifications", nil, 1)
}
