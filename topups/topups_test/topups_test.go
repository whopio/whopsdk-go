...
func TestTopupsCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Topups.Create(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestTopupsCreateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestTopupsCreateWithWireMock", "POST", "/topups", nil, 1)
}
