...
package checkout_sessions_test
...
func TestCheckoutSessionsCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.CheckoutSessions.Create(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestCheckoutSessionsCreateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestCheckoutSessionsCreateWithWireMock", "POST", "/checkout_sessions", nil, 1)
}
