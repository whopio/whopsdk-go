...
func (r *RawClient) Summary(
...
) (*core.Response[*whopsdk.SummaryDisputesResponse], error) {
	...
	endpointURL := baseURL + "/disputes/summary"
	...
	var response *whopsdk.SummaryDisputesResponse
	...
	return &core.Response[*whopsdk.SummaryDisputesResponse]{
...
func (r *RawClient) SubmitEvidenceDispute(
	ctx context.Context,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/disputes/%v/submit_evidence",
		request.ID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) UpdateEvidenceDispute(
	ctx context.Context,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/disputes/%v/update_evidence",
		request.ID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) UploadEvidence(
	ctx context.Context,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/disputes/%v/upload_evidence",
		request.ID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
