...
func TestDisputesListWithWireMock(
	...
	VerifyRequestCount(t, "TestDisputesListWithWireMock", "GET", "/disputes", nil, 1)
}

func TestDisputesSummaryWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.Disputes.Summary(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestDisputesSummaryWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestDisputesSummaryWithWireMock", "GET", "/disputes/summary", nil, 1)
}

func TestDisputesRetrieveWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.Disputes.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestDisputesRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestDisputesRetrieveWithWireMock", "GET", "/disputes/id", nil, 1)
}

func TestDisputesUpdateWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.Disputes.Update(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestDisputesUpdateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestDisputesUpdateWithWireMock", "PATCH", "/disputes/id", nil, 1)
}

func TestDisputesSubmitWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.Disputes.Submit(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestDisputesSubmitWithWireMock"}},
		),
	)
...
func TestDisputesUploadEvidenceWithWireMock(
	...
	_, invocationErr := client.Disputes.UploadEvidence(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestDisputesUploadEvidenceWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestDisputesUploadEvidenceWithWireMock", "POST", "/disputes/id/upload_evidence", nil, 1)
}
