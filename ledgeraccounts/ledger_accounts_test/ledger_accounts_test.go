...
func TestLedgerAccountsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.LedgerAccounts.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestLedgerAccountsRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestLedgerAccountsRetrieveWithWireMock", "GET", "/ledger_accounts/ldgr_xxxxxxxxxxxxx", nil, 1)
}
