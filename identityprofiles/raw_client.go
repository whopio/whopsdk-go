...
func (r *RawClient) RetrieveIdentityProfile(
	ctx context.Context,
	request *whopsdk.RetrieveIdentityProfileRequest,
	opts ...option.RequestOption,
) (*core.Response[*whopsdk.IdentityProfile], error) {
	...
	var response *whopsdk.IdentityProfile
	...
	return &core.Response[*whopsdk.IdentityProfile]{
...
func (r *RawClient) UnlinkIdentityProfile(
	ctx context.Context,
