...
func (r *RawClient) GetFinancialReport(
	ctx context.Context,
	request *whopsdk.GetFinancialReportRequest,
	opts ...option.RequestOption,
) (*core.Response[*whopsdk.GetFinancialReportResponse], error) {
	...
	var response *whopsdk.GetFinancialReportResponse
	...
	return &core.Response[*whopsdk.GetFinancialReportResponse]{
