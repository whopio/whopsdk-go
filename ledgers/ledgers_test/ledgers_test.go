...
func TestLedgersGetFinancialReportWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Ledgers.GetFinancialReport(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestLedgersGetFinancialReportWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestLedgersGetFinancialReportWithWireMock", "GET", "/financial_reports", map[string]interface{}{"account_id": "account_id", "report_type": "balance_summary"}, 1)
}
