...
func TestEntriesListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Entries.List(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEntriesListWithWireMock"}},
		),
	)
...
func TestEntriesRetrieveWithWireMock(
	...
	_, invocationErr := client.Entries.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEntriesRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEntriesRetrieveWithWireMock", "GET", "/entries/entry_xxxxxxxxxxxx", nil, 1)
}

func TestEntriesApproveWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.Entries.Approve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEntriesApproveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEntriesApproveWithWireMock", "POST", "/entries/entry_xxxxxxxxxxxx/approve", nil, 1)
}

func TestEntriesDenyWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.Entries.Deny(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEntriesDenyWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEntriesDenyWithWireMock", "POST", "/entries/entry_xxxxxxxxxxxx/deny", nil, 1)
}
