...
func TestAdReportsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.AdReports.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestAdReportsRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestAdReportsRetrieveWithWireMock", "GET", "/ad_reports", map[string]interface{}{"company_id": "biz_xxxxxxxxxxxxxx", "from": "2023-12-01T05:00:00.000Z", "to": "2023-12-01T05:00:00.000Z"}, 1)
}
