...
func (r *RawClient) Create(
...
) (*core.Response[*whopsdk.TeamMember], error) {
	...
	var response *whopsdk.TeamMember
	...
	return &core.Response[*whopsdk.TeamMember]{
...
func (r *RawClient) Delete(
	...
	opts ...option.RequestOption,
) (*core.Response[*whopsdk.DeleteTeamMembersResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *whopsdk.DeleteTeamMembersResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*whopsdk.DeleteTeamMembersResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
