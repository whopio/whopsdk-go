...
func TestSettersMember(t *testing.T) {
	...
	t.Run("SetTokenBalance", func(t *testing.T) {
		obj := &Member{}
		var fernTestValueTokenBalance float64
		obj.SetTokenBalance(fernTestValueTokenBalance)
		assert.Equal(t, fernTestValueTokenBalance, obj.TokenBalance)
		assert.NotNil(t, obj.explicitFields)
	})
...
func TestGettersMember(t *testing.T) {
	...
	t.Run("GetTokenBalance", func(t *testing.T) {
		...
		obj.TokenBalance = expected

		// Act & Assert
		assert.Equal(t, expected, obj.GetTokenBalance(), "getter should return the property value")
	})

	t.Run("GetTokenBalance_NilReceiver", func(t *testing.T) {
		t.Parallel()
		var obj *Member
		// Should not panic - getters should handle nil receiver gracefully
		defer func() {
		...
		_ = obj.GetTokenBalance() // Should return zero value
	})
...
func TestSettersMarkExplicitMember(t *testing.T) {
	...
	t.Run("SetTokenBalance_MarksExplicit", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &Member{}
		var fernTestValueTokenBalance float64
...
func TestSettersPostMemberUpdatedPayload(t *testing.T) {
	t.Run("SetAccountID", func(t *testing.T) {
		obj := &PostMemberUpdatedPayload{}
		var fernTestValueAccountID *string
		obj.SetAccountID(fernTestValueAccountID)
		assert.Equal(t, fernTestValueAccountID, obj.AccountID)
		assert.NotNil(t, obj.explicitFields)
	...
	t.Run("SetAPIVersion", func(t *testing.T) {
		obj := &PostMemberUpdatedPayload{}
		var fernTestValueAPIVersion PostMemberUpdatedPayloadAPIVersion
		obj.SetAPIVersion(fernTestValueAPIVersion)
		assert.Equal(t, fernTestValueAPIVersion, obj.APIVersion)
		assert.NotNil(t, obj.explicitFields)
	})
	...
	t.Run("SetType", func(t *testing.T) {
		obj := &PostMemberUpdatedPayload{}
		var fernTestValueType PostMemberUpdatedPayloadType
		obj.SetType(fernTestValueType)
		assert.Equal(t, fernTestValueType, obj.Type)
		assert.NotNil(t, obj.explicitFields)
	})
...
func TestGettersPostMemberUpdatedPayload(t *testing.T) {
	t.Run("GetAccountID", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &PostMemberUpdatedPayload{}
	...
	t.Run("GetAPIVersion", func(t *testing.T) {
		...
		// Arrange
		obj := &PostMemberUpdatedPayload{}
		var expected PostMemberUpdatedPayloadAPIVersion
		obj.APIVersion = expected
	...
	t.Run("GetType", func(t *testing.T) {
		...
		// Arrange
		obj := &PostMemberUpdatedPayload{}
		var expected PostMemberUpdatedPayloadType
		obj.Type = expected
...
func TestSettersMarkExplicitPostMemberUpdatedPayload(t *testing.T) {
	t.Run("SetAccountID_MarksExplicit", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &PostMemberUpdatedPayload{}
...
func TestJSONMarshalingPostMemberUpdatedPayload(t *testing.T) {
	t.Run("MarshalUnmarshal", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &PostMemberUpdatedPayload{}
		...
		// Unmarshal back and verify round-trip
		var unmarshaled PostMemberUpdatedPayload
		err = json.Unmarshal(data, &unmarshaled)
		assert.NoError(t, err, "round-trip unmarshal should succeed")
	})
...
func TestStringPostMemberUpdatedPayload(t *testing.T) {
	t.Run("StringMethod", func(t *testing.T) {
		t.Parallel()
		obj := &PostMemberUpdatedPayload{}
		result := obj.String()
...
func TestEnumPostMemberUpdatedPayloadAPIVersion(t *testing.T) {
	t.Run("NewFromString_v1", func(t *testing.T) {
		t.Parallel()
		val, err := NewPostMemberUpdatedPayloadAPIVersionFromString("v1")
		assert.NoError(t, err, "valid enum value should not return error")
		assert.Equal(t, PostMemberUpdatedPayloadAPIVersion("v1"), val, "enum value should match expected wire value")
	})

	t.Run("NewFromString_Invalid", func(t *testing.T) {
		_, err := NewPostMemberUpdatedPayloadAPIVersionFromString("invalid_value_that_does_not_exist")
		assert.Error(t, err)
	})
...
func TestEnumPostMemberUpdatedPayloadType(t *testing.T) {
	t.Run("NewFromString_member_updated", func(t *testing.T) {
		t.Parallel()
		val, err := NewPostMemberUpdatedPayloadTypeFromString("member.updated")
		assert.NoError(t, err, "valid enum value should not return error")
		assert.Equal(t, PostMemberUpdatedPayloadType("member.updated"), val, "enum value should match expected wire value")
	})

	t.Run("NewFromString_Invalid", func(t *testing.T) {
		_, err := NewPostMemberUpdatedPayloadTypeFromString("invalid_value_that_does_not_exist")
		assert.Error(t, err)
	})
...
func TestExtraPropertiesPostMemberUpdatedPayload(t *testing.T) {
	t.Run("GetExtraProperties", func(t *testing.T) {
		t.Parallel()
		obj := &PostMemberUpdatedPayload{}
		// Should not panic when calling GetExtraProperties()
