...
// WithAPIVersionDate sets the apiVersionDate request header.
func WithAPIVersionDate(apiVersionDate *string) *core.APIVersionDateOption {
	return &core.APIVersionDateOption{
		APIVersionDate: apiVersionDate,
	}
}
