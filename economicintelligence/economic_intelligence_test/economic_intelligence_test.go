...
package economic_intelligence_test
...
func TestEconomicIntelligenceListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.EconomicIntelligence.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEconomicIntelligenceListWithWireMock"}},
		),
	)
...
func TestEconomicIntelligenceRunWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.EconomicIntelligence.Run(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEconomicIntelligenceRunWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEconomicIntelligenceRunWithWireMock", "POST", "/economic_intelligence", nil, 1)
}
