...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.APIVersionDate != nil {
		header.Set("Api-Version-Date", fmt.Sprintf("%v", *r.APIVersionDate))
	}
	if r.IdempotencyKey != nil {
		header.Set("Idempotency-Key", fmt.Sprintf("%v", *r.IdempotencyKey))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/whopio/whopsdk-go/v2")
	headers.Set("X-Fern-SDK-Version", "v2.0.0")
	headers.Set("User-Agent", "github.com/whopio/whopsdk-go/v2/2.0.0")
	return headers
}
...
// APIVersionDateOption implements the RequestOption interface.
type APIVersionDateOption struct {
	APIVersionDate *string
}

func (a *APIVersionDateOption) applyRequestOptions(opts *RequestOptions) {
	opts.APIVersionDate = a.APIVersionDate
}
...
func (i *IdempotencyKeyOption) applyRequestOptions(opts *RequestOptions) {
