...
func (r *RawClient) Retrieve(
...
) (*core.Response[*whopsdk.CourseLessonInteraction], error) {
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/course_lesson_interactions/%v",
		request.ID,
	)
	...
	var response *whopsdk.CourseLessonInteraction
	...
	return &core.Response[*whopsdk.CourseLessonInteraction]{
