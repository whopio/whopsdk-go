...
import (
	...
	businesses "github.com/whopio/whopsdk-go/v2/partners/businesses"
)
...
func (c *Client) List(
...
) (*core.Page[*string, *businesses.ListEarningsResponseDataItem, *businesses.ListEarningsResponse], error) {
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/partners/businesses/%v/earnings",
		request.ID,
	)
	...
	readPageResponse := func(response *businesses.ListEarningsResponse) *core.PageResponse[*string, *businesses.ListEarningsResponseDataItem, *businesses.ListEarningsResponse] {
		...
		return &core.PageResponse[*string, *businesses.ListEarningsResponseDataItem, *businesses.ListEarningsResponse]{
			Results:  results,
			Response: response,
			Next:     next,
