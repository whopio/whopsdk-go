...
package payouts_supported_methods_test
...
func TestPayoutsSupportedMethodsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Payouts.SupportedMethods.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestPayoutsSupportedMethodsListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestPayoutsSupportedMethodsListWithWireMock", "GET", "/payouts/supported_methods", nil, 1)
}
