...
package financial_activity_test
...
func TestFinancialActivityListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FinancialActivity.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestFinancialActivityListWithWireMock"}},
		),
	)
