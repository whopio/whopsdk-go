...
func (r *RawClient) Create(
...
) (*core.Response[*whopsdk.PromoCode], error) {
	...
	var response *whopsdk.PromoCode
	...
	return &core.Response[*whopsdk.PromoCode]{
...
func (r *RawClient) Delete(
	...
	opts ...option.RequestOption,
) (*core.Response[*whopsdk.DeletePromoCodesResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *whopsdk.DeletePromoCodesResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*whopsdk.DeletePromoCodesResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) Activate(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/promo_codes/%v/activate",
		request.ID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) Deactivate(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/promo_codes/%v/deactivate",
		request.ID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
