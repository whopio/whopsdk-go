...
func TestPermissionsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Permissions.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestPermissionsListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestPermissionsListWithWireMock", "GET", "/permissions", map[string]interface{}{"resource_id": "resource_id"}, 1)
}
