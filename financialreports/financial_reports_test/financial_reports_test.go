...
package financial_reports_test
...
func TestFinancialReportsRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FinancialReports.Retrieve(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestFinancialReportsRetrieveWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestFinancialReportsRetrieveWithWireMock", "GET", "/financial_reports", map[string]interface{}{"account_id": "account_id", "report_type": "balance_summary"}, 1)
}
