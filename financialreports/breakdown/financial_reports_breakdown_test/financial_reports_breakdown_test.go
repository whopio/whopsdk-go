...
package financial_reports_breakdown_test
...
func TestFinancialReportsBreakdownRetrieveWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.FinancialReports.Breakdown.Retrieve(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestFinancialReportsBreakdownRetrieveWithWireMock"}},
		),
	)
